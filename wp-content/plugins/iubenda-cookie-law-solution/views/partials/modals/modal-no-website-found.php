...
<div id="modal-no-website-found" class="modal" style="z-index: 999999 !important;">
	<div class="iub-modal__window iub-modal__window--md p-4 p-lg-5">
		<div class="modalSync">
			...
			<div class="btn btn-gray-lighter btn-block btn-sm iub-show-modal" data-modal-name="#modal-setup-screen"> <?php esc_html_e( 'I want to start from scratch', 'iubenda' ); ?></div>
		</div>
	</div>
</div>
